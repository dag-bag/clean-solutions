...
const WasteWaterTreatment = ({ title, category, onComplete }: any) => {
    ...
    return (
        <Layout {...{
            ...
            {step == 1 && (
                <Question name="How much water can each system with wastewater hold? ">
                    <MultipleNestedSelect
                        options={['Pools, Hot tubs, and Spas ', 'Canning Retort and Pasteurizer', ' Electronic Cooling Towers', 'Stainless Steel Transfer Lines, and Hydrocoolers ', 'Other Recirculating Water Systems ']}
            ...
            {step == 3 && (
                <Question name='How long would you like a supply to last?'>
                    <Select
