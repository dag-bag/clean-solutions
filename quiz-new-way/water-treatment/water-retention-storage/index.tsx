    ...
    return (
        <div>
            ...
            <div>
                ...
                {step == 1 && (
                    <div>
                        <h1 className='text-2xl py-2 font-semibold'>How many times per month do you want to sanitize water containment?</h1>
                ...
                {step == 3 && (
                    <div>
                        <h1 className='text-2xl py-2 font-semibold'>How long would you like a water storage sanitizer supply to last?</h1>
                        <Select
