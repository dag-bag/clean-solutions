        ...
        <Layout onNext={Next} onPrevious={Prevous}>
            <div className="flex items-center justify-center h-screen lg:p-20 md:p-20  flex-col-reverse md:flex-row scrollbar-hide border ">
                <div className="flex-1 mt-5">
                    <h1 className=" py-5  md:text-[70px] text-[30px] md:leading-[70px] leading-[50px] font-semibold text-center text-blue-1">Hey <b className="text-green-1 capitalize font-semibold">"{userName}" </b> <br /> Welcome to Clean Tech Solutions</h1>
                </div>
