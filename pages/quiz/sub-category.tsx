...
const disebledSubCategories = ['wastewater treatment', 'body sanitizer & deodrant', 'camping hunting & scent eleminator', 'livestock sanitizer and deodorizer', 'food surfaces and packages', 'greenhouse and garden', 'fog rooms and carpenting', 'gyms spas clubs & locker rooms',
