  ...
  return (
    <>
      ...
      >
        ...
        >
          <h1
            className={` text-left text-[20px] md:text-[21px] py-1 font-semibold  uppercase ${
          ...
          <p
            className={`text-left mt-2 text-md font-[400] md:text-[16px] ${
              !isSelected ? "text-black" : "text-white"
            }`}
          >
            {data.discription}
          ...
          <div className="flex items-center justify-between gap-5 py-3">
            <div
              ...
              className={`md:btn-md btn-sm w-20 md:w-auto p-2  h-auto  px-5 btn btn-secondary ${
                !isSelected ? "bg-green-1" : "bg-white text-green-1"
              } border-none text-black hover:text-white font-[500] capitalize  md:inline-flex`}
            >
